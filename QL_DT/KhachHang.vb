...
Public Class KhachHang
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            Dim connec As New MySqlConnection("sql6.freesqldatabase.com;user=sql6131814;password=IdfIaLZefF;database=sql6131814")
            Dim reader As MySqlDataReader
            Try
                connec.Open()
                Dim Query As String
                Query = "insert into sql6131814.khachhang (ma_kh,ten_kh,diachi_kh,sdt_kh) values ('" & txtMa.Text & "','" & txtTen.Text & "','" & txtDia.Text & "','" & txtdt.Text & "')"
    ...
    Private Sub load_Table()
        ...
        Try
            connec.Open()
            Dim Query As String
            Query = "select * from sql6131814.khachhang"
            Dim command As New MySqlCommand(Query, connec)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Else
            ...
            Try
                connec.Open()
                Dim Query As String
                Query = "update sql6131814.khachhang set ten_kh='" & txtTen.Text & "',diachi_kh='" & txtDia.Text & "',sdt_kh='" & txtdt.Text & "' where ma_kh='" & txtMa.Text & "'"
                Dim command As New MySqlCommand(Query, connec)
                reader = command.ExecuteReader
